...
uint32_t MACHINES_STATE_TIME_MARKERS[NO_OF_MACHINES] = {0};
/** Implementation specific machine status durations for keeping edge-case state timestamps */
uint32_t MACHINES_STATE_TIME_DURATION_UPON_STATE_CHANGE[NO_OF_MACHINES] = {0};

uint8_t rms_averaging_sample_count = 0, rms_status_assignment_sample_count = 0;
float RMS_buffer[NO_OF_MACHINES*n_for_rms_averaging] = {0};
float RMS_long_buffer[NO_OF_MACHINES*n_for_rms_status_assignment]={0};
