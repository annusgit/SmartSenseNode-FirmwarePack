...
/* MLX90614 IR Temperater Sensor Variables */
extern uint16_t MLX90614_data;
extern uint8_t MLX90614_data_bytes[2], MLX90614_special_bytes[2], MLX90614_pec;
/* NTC Thermistor 4092 50k Temperater Sensor Variables */
extern float NTC_Thermistor_4092_50k_LUT_Resistance[THERMISTOR_LUT_SIZE], NTC_Thermistor_4092_50k_LUT_Temperature_Celcius[THERMISTOR_LUT_SIZE];
extern uint8_t NTC_Thermistor_4092_50k_special_bytes[2];
...
extern uint32_t sample_counter[82];
 ...
 */
uint8_t ambient_condition_status(uint8_t temperature_min_threshold, uint8_t temperature_max_threshold, uint8_t humidity_min_threshold, uint8_t humidity_max_threshold);
