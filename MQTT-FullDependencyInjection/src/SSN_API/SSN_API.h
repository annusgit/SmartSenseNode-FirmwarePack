...
void SSN_GET_TIMEOFDAY(uint8_t* ssn_mac_address, uint8_t* ssn_prev_state, uint8_t* ssn_current_state, bool* timeofday_received, uint8_t allowed_mqtt_failure_counts, Network* net, 
	MQTTClient* mqtt_client, opts_struct* mqtt_options, MQTTPacket_connectData* mqtt_datapacket, uint8_t *ssn_server_ip, char* cliendId_node_exclusive_channel, void* messageArrivedoverMQTT);
int SSN_Check_Connection_And_Reconnect(uint8_t* ssn_prev_state, uint8_t* ssn_current_state, int return_code, Network* net, MQTTClient* mqtt_client, opts_struct* mqtt_options, 
    MQTTPacket_connectData* mqtt_datapacket, uint8_t *ssn_server_ip, char* cliendId_node_exclusive_channel, void* messageArrivedoverMQTT);
...
void SSN_REQUEST_Time_of_Day_AFTER_N_SECONDS(uint32_t ssn_uptime_right_now, uint32_t seconds, uint8_t allowed_mqtt_failure_counts, uint8_t* ssn_mac_address, uint8_t* ssn_prev_state, 
    uint8_t* ssn_current_state, bool* timeofday_received, Network* net, MQTTClient* mqtt_client, opts_struct* mqtt_options, MQTTPacket_connectData* mqtt_datapacket, uint8_t *ssn_server_ip, 
