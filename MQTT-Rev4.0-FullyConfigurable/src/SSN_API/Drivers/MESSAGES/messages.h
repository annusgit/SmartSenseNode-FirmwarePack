...
#define GET_SENSOR_CONFIG_MESSAGE_ID        5
/** Message id for set current sensor configurations message received from Server */
#define SET_SENSOR_CONFIG_MESSAGE_ID        6
/** Message id for acknowledge sensor configurations message to Server */
#define ACK_SENSOR_CONFIG_MESSAGE_ID        7
...
/** Message id for getting node configurations from Server */
#define GET_NETWORK_CONFIG_MESSAGE_ID       13
/** Message id for setting node configurations from Server */
#define SET_NETWORK_CONFIG_MESSAGE_ID       14
/** Message id for acknowledging network configurations message to Server */
#define ACK_NETWORK_CONFIG_MESSAGE_ID        15
...
#define GET_NETWORK_CONFIG_MESSAGE_Size     7
#define SET_NETWORK_CONFIG_MESSAGE_Size     
