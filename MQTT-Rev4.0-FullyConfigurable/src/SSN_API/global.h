...
#define NO_SENSOR_CONFIG_STATE              4
...
#define NO_NETWORK_CONFIG_STATE             12
...
/* EEPROM Read/Write Position for network configurations */
#define EEPROM_NETWORK_CONFIG_BLOCK         4
#define EEPROM_NETWORK_CONFIG_LOC           12
#define EEPROM_NETWORK_CONFIG_MIN_SIZE      18
/* EEPROM Read/Write Position for sensor configurations */
#define EEPROM_SENSOR_CONFIG_BLOCK          3
#define EEPROM_SENSOR_CONFIG_LOC            100
#define EEPROM_SENSOR_CONFIG_SIZE           21
...
static inline void SSN_LED_INDICATE(uint8_t this_state) {
    ...
    switch (this_state) {
        ...
        case ESTABLISHING_MQTT_CONNECTION:
            establishing_connection_LED_INDICATE();
            break;   
        case NO_NETWORK_CONFIG_STATE:
            Node_Up_Not_Configured_LED_INDICATE();
            break;            
        /* No sensor configuration? */
        case NO_SENSOR_CONFIG_STATE:
            Node_Up_Not_Configured_LED_INDICATE();
            break;
        /* No time of day? */
